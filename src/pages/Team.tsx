...
const Team = () => {
  ...
  return (
    <div className="flex-1 h-full pt-4 pb-4 px-8 lg:px-28 overflow-auto">
      <div className="lg:pt-0 pt-5 mb-14">
        ...
        <div className="lg:flex ">
          <div className="lg:mt-11">
            ...
            <Link to="/create-team">
              <button className="bg-[#FCD34D] my-8 text-xl font-bold py-2 px-6 rounded-lg shadow-lg flex items-center gap-3 justify-center transition-transform duration-300 mx-auto md:mx-0 hover:scale-105">
                Create Team
              </button>
            </Link>
          </div>
        ...
        {!teams || teams.length === 0 ? (
          <div className="flex flex-col items-center justify-center mt-4 text-center">
            ...
            <p className="text-lg text-gray mb-6">
              You haven't joined or created a team yet. Start collaborating
              today by creating your own team!
            </p>
          </div>
        ) : (
          <div className="space-y-4">
            <h1 className="text-text text-3xl text-center my-7 font-bold">
              Teams
            </h1>
            {loading ? (
              ...
              <div>
                {teams.map((team, index) => (
                  <div key={index} className="lg:px-28 overflow-hidden">
