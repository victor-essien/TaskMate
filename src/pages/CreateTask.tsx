...
<div className='flex gap-9  text-text font-bold my-4'>
    <IoMdClose onClick={() =>logout()} size={32} className='font-bold'  />
    <h2 className='text-3xl font-semibold mb-6 text-text'>Create New Task</h2>
    </div>
    
    <div className='mb-4 border-b border-text'>
    <label className="block text-lg font-semibold mb-2 text-gray">Task Name</label>
    <input type="text"
    value={taskName}
    ...
    <div className='mb-4 border-b border-text'>
    <label className='block text-lg font-semibold mb-2 text-gray'>Start Date</label>
     ...
     <DatePicker
         ...
         <FaCalendarAlt className="absolute top-3 right-3 text-gray"
    ...
    <div className="mb-4 border-b border-text">
        <label className="block text-lg font-semibold mb-2 text-gray">End Date</label>
        ...
        <DatePicker
          ...
          />
          <FaCalendarAlt className="absolute top-3 right-3 text-gray"
           onClick={() => document.querySelectorAll<HTMLInputElement>(".react-datepicker__input-container input")[1]?.focus()}
          />
        </div>
      </div>
      ...
      {/* Description */}
      <div className="mb-4 border-b border-text">
        <label className="block text-lg font-semibold text-gray mb-2">Description</label>
        <textarea
      ...
      <div className="mb-6">
        ...
        <div className="flex items-center space-x-4">
          {["bg-purple", "bg-yellow", "bg-gray", "bg-green"].map(
            (color) => (
              <button
                key={color}
