...
const CommentSection: React.FC<Props> = ({ teamId, taskId, userName }) => {
  ...
  return (
    <div className="relative h-full flex flex-col pb-2">
      ...
      <div></div>
      <div className="lg:relative fixed  bottom-0 left-0 right-0  bg-bgColor p-4 border-b  shadow-md">
        <div className="flex items-center space-x-2 mb-2">
          ...
          <button
            ...
            className="bg-[#3B82F6] text-white px-4 py-2 rounded-lg text-lg font-bold hover:bg-blue-600"
          >
            Add
          </button>
        </div>
